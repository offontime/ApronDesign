...
V.prototype.set = function(e, t, i, o) {
  ...
  this.data[r] = i, o && (this.reservedBit[r] = true);
};
...
var It = "[0-9]+";
var zt = "[A-Z $%*+\\-./:]+";
var z = "(?:[u3000-u303F]|[u3040-u309F]|[u30A0-u30FF]|[uFF00-uFFEF]|[u4E00-u9FAF]|[u2605-u2606]|[u2190-u2195]|u203B|[u2010u2015u2018u2019u2025u2026u201Cu201Du2225u2260]|[u0391-u0451]|[u00A7u00A8u00B1u00B4u00D7u00F7])+";
z = z.replace(/u/g, "\\u");
var Ht = "(?:(?![A-Z0-9 $%*+\\-./:]|" + z + `)(?:.|[\r
]))+`;
...
var Vt = new RegExp("^" + z + "$");
var Kt = new RegExp("^" + It + "$");
var Jt = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
function ae(e, t) {
  ...
  for (let r = 0; r < o.length; r++) {
    ...
    for (let c = -1; c <= 7; c++)
      if (!(n + c <= -1 || i <= n + c))
        for (let u = -1; u <= 7; u++)
          s + u <= -1 || i <= s + u || (c >= 0 && c <= 6 && (u === 0 || u === 6) || u >= 0 && u <= 6 && (c === 0 || c === 6) || c >= 2 && c <= 4 && u >= 2 && u <= 4 ? e.set(n + c, s + u, true, true) : e.set(n + c, s + u, false, true));
  }
}
function le(e) {
  const t = e.size;
  for (let i = 8; i < t - 8; i++) {
    const o = i % 2 === 0;
    e.set(i, 6, o, true), e.set(6, i, o, true);
  }
}
function fe(e, t) {
  ...
  for (let o = 0; o < i.length; o++) {
    ...
    for (let s = -2; s <= 2; s++)
      for (let c = -2; c <= 2; c++)
        s === -2 || s === 2 || c === -2 || c === 2 || s === 0 && c === 0 ? e.set(r + s, n + c, true, true) : e.set(r + s, n + c, false, true);
  }
}
function ge(e, t) {
  ...
  let r, n, s;
  for (let c = 0; c < 18; c++)
    r = Math.floor(c / 3), n = c % 3 + i - 8 - 3, s = (o >> c & 1) === 1, e.set(r, n, s, true), e.set(n, r, s, true);
}
function nt(e, t, i) {
  const o = e.size, r = ue.getEncodedBits(t, i);
  let n, s;
  for (n = 0; n < 15; n++)
    s = (r >> n & 1) === 1, n < 6 ? e.set(n, 8, s, true) : n < 8 ? e.set(n + 1, 8, s, true) : e.set(o - 15 + n, 8, s, true), n < 8 ? e.set(8, o - n - 1, s, true) : n < 9 ? e.set(8, 15 - n - 1 + 1, s, true) : e.set(8, 15 - n - 1, s, true);
  e.set(o - 8, 8, 1, true);
}
function de(e, t) {
  const i = e.size;
...
function Ce(e, t, i) {
  let o = "", r = 0, n = false, s = 0;
  for (let c = 0; c < e.length; c++) {
    const u = Math.floor(c % t), a = Math.floor(c / t);
    !u && !n && (n = true), e[c] ? (s++, c > 0 && u > 0 && e[c - 1] || (o += n ? rt("M", u + i, 0.5 + a + i) : rt("m", r, 0), r = 0, n = false), u + 1 < t && e[c + 1] || (o += rt("h", s), s = 0)) : r++;
  }
  return o;
}
...
var Ie = Object.assign({
  ...
  setup(e, { emit: t }) {
    const i = e, o = ref(i.text), r = ref(""), n = ref(null);
    function s(c) {
      const u = {
    ...
    return s(o.value), (c, u) => (openBlock(), createElementBlock("div", pe, [
      e.mode === "canvas" ? (openBlock(), createElementBlock("canvas", {
        key: 0,
        ref_key: "renderCanvas",
        ref: n
      }, null, 512)) : (openBlock(), createElementBlock("img", {
        key: 1,
        src: r.value
      }, null, 8, Ae))
    ]));

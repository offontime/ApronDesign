import {
  ...
  ref,
  unref
} from "./chunk-HTCWHMP6.js";
import {
  normalizeStyle
} from "./chunk-DP4PHTIW.js";
...
G.prototype.set = function(x, e, n, c) {
  ...
  this.data[t] = n, c && (this.reservedBit[t] = true);
};
...
var j0 = new RegExp("^" + O + "$");
var Z0 = new RegExp("^" + T0 + "$");
var q0 = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
function v1(x, e) {
  ...
  for (let t = 0; t < c.length; t++) {
    ...
    for (let f = -1; f <= 7; f++)
      if (!(a + f <= -1 || n <= a + f))
        for (let i = -1; i <= 7; i++)
          r + i <= -1 || n <= r + i || (f >= 0 && f <= 6 && (i === 0 || i === 6) || i >= 0 && i <= 6 && (f === 0 || f === 6) || f >= 2 && f <= 4 && i >= 2 && i <= 4 ? x.set(a + f, r + i, true, true) : x.set(a + f, r + i, false, true));
  }
}
function w1(x) {
  const e = x.size;
  for (let n = 8; n < e - 8; n++) {
    const c = n % 2 === 0;
    x.set(n, 6, c, true), x.set(6, n, c, true);
  }
}
function E1(x, e) {
  ...
  for (let c = 0; c < n.length; c++) {
    ...
    for (let r = -2; r <= 2; r++)
      for (let f = -2; f <= 2; f++)
        r === -2 || r === 2 || f === -2 || f === 2 || r === 0 && f === 0 ? x.set(t + r, a + f, true, true) : x.set(t + r, a + f, false, true);
  }
}
function p1(x, e) {
  ...
  let t, a, r;
  for (let f = 0; f < 18; f++)
    t = Math.floor(f / 3), a = f % 3 + n - 8 - 3, r = (c >> f & 1) === 1, x.set(t, a, r, true), x.set(a, t, r, true);
}
function t0(x, e, n) {
  const c = x.size, t = g1.getEncodedBits(e, n);
  let a, r;
  for (a = 0; a < 15; a++)
    r = (t >> a & 1) === 1, a < 6 ? x.set(a, 8, r, true) : a < 8 ? x.set(a + 1, 8, r, true) : x.set(c - 15 + a, 8, r, true), a < 8 ? x.set(8, c - a - 1, r, true) : a < 9 ? x.set(8, 15 - a - 1 + 1, r, true) : x.set(8, 15 - a - 1, r, true);
  x.set(c - 8, 8, 1, true);
}
function y1(x, e) {
  const n = x.size;
...
function I1(x, e, n) {
  let c = "", t = 0, a = false, r = 0;
  for (let f = 0; f < x.length; f++) {
    const i = Math.floor(f % e), s = Math.floor(f / e);
    !i && !a && (a = true), x[f] ? (r++, f > 0 && i > 0 && x[f - 1] || (c += a ? c0("M", i + n, 0.5 + s + n) : c0("m", t, 0), t = 0, a = false), i + 1 < e && x[f + 1] || (c += c0("h", r), r = 0)) : t++;
  }
  return c;
}
...
var z0 = Object.assign({
  ...
  setup(x, { emit: e }) {
    ...
    return a(c.value), (r, f) => (openBlock(), createElementBlock("div", P1, [
      createBaseVNode("img", { src: t.value }, null, 8, N1)
    ]));
  }
});
var o = {
  ...
  bc_str2num: function(x, e) {
    var n, c, t, a, r, f, i;
    for (n = x.split(""), t = 0, a = 0, r = 0, f = false, (n[t] === "+" || n[t] === "-") && t++; n[t] === "0"; )
      t++;
    for (; n[t] % 1 === 0; )
      t++, a++;
    for (n[t] === "." && t++; n[t] % 1 === 0; )
    ...
    for (r = o.MIN(r, e), a === 0 && (f = true, a = 1), c = o.bc_new_num(a, r), t = 0, n[t] === "-" ? (c.n_sign = o.MINUS, t++) : (c.n_sign = o.PLUS, n[t] === "+" && t++); n[t] === "0"; )
      t++;
...
o.bc_add = function(x, e, n) {
  ...
  if (x.n_sign === e.n_sign)
    ...
    switch (t = o._bc_do_compare(x, e, false, false), t) {
      case -1:
...
o.bc_compare = function(x, e) {
  return o._bc_do_compare(x, e, true, false);
};
...
o.bc_divide = function(x, e, n) {
  ...
  for (d = x.n_len + _, u = x.n_scale - _, u < n ? p = n - u : p = 0, t = o.safe_emalloc(1, x.n_len + x.n_scale, p + 2), t === null && o.bc_out_of_memory(), o.memset(t, 0, 0, x.n_len + x.n_scale + p + 2), o.memcpy(t, 1, x.n_value, 0, x.n_len + x.n_scale), b = e.n_len + _, a = o.safe_emalloc(1, b, 1), a === null && o.bc_out_of_memory(), o.memcpy(a, 0, e.n_value, 0, b), a[b] = 0, i = 0; a[i] === 0; )
    i++, b--;
  if (b > d + n ? (h = n + 1, S = true) : (S = false, b > d ? h = n + 1 : h = d - b + n + 1), c = o.bc_new_num(h - n, n), o.memset(c.n_value, 0, 0, h), y = o.safe_emalloc(1, b, 1), y === null && o.bc_out_of_memory(), !S)
    ...
    */
    init: function(x, e, n) {
      ...
      for (var a = 0; a < c.length; a++) {
        var r = this.getCompaction(c[a][0], c[a][1], true);
        t = t.concat(r);
      }
      t[0] == 900 && t.shift();
      var f = t.length;
      ...
      switch (x) {
        case 900: {
          for (var t = 0, a = [], r = e.length, f = 0; f < r; ++f) {
            ...
            if ((s = this._array_search(i, this.textsubmodes[t])) !== false)
              a.push(s);
            else
              for (var u = 0; u < 4; ++u)
                if (u != t && (s = this._array_search(i, this.textsubmodes[u])) !== false) {
                  (f + 1 == r || f + 1 < r && this._array_search(
                    this._ord(e.charAt(f + 1)),
                    this.textsubmodes[t]
                  ) !== false) && (u == 3 || u == 0 && t == 1) ? u == 3 ? a.push(29) : a.push(27) : (a = a.concat(this.textlatch["" + t + u]), t = u), a.push(s);
                  break;
                }
          }
          var l = a.length;
    ...
    _sprintf: function() {
      var x = /%%|%(\d+\$)?([-+\'#0 ]*)(\*\d+\$|\*|\d+)?(\.(\*\d+\$|\*|\d+))?([scboxXuideEfFgG])/g, e = arguments, n = 0, c = e[n++], t = function(s, u, l, d) {
        ...
        var h = d - s.length;
        return h > 0 && (l || !b ? s = t(s, d, _, l) : s = s.slice(0, u.length) + t("", h, "0", true) + s.slice(u.length)), s;
        ...
        return l = l && p && {
          ...
          8: "0",
          16: "0x"
        }[u] || "", s = l + t(p.toString(u), _ || 0, "0", false), a(s, l, d, b, h);
        ...
        if (s == "%%")
          return "%";
        for (var E = false, y = "", S = false, C = false, B = " ", A = l.length, M = 0; l && M < A; M++)
          switch (l.charAt(M)) {
            case " ":
              y = " ";
              break;
        ...
        if (d ? d == "*" ? d = +e[n++] : d.charAt(0) == "*" ? d = +e[d.slice(1, -1)] : d = +d : d = 0, d < 0 && (d = -d, E = true), !isFinite(d))
        ...
        switch (_ ? _ == "*" ? _ = +e[n++] : _.charAt(0) == "*" ? _ = +e[_.slice(1, -1)] : _ = +_ : _ = "fFeE".indexOf(h) > -1 ? 6 : h == "d" ? 0 : void 0, m = u ? e[u.slice(0, -1)] : e[n++], h) {
          ...
          case "i":
          case "d":
            return p = +m || 0, p = Math.round(p - p % 1), v = p < 0 ? "-" : y, m = v + t(String(Math.abs(p)), _, "0", false), a(m, v, E, d, S);
          case "e":
          case "E":
          case "f":
          case "F":
    ...
    _preg_split: function(x, e, n, c) {
      n = n || 0, c = c || "";
      var t, a = [], r = 0, f = 0, i = false, s = false, u = false, l = {}, d = 0, b = /^\/(.*)\/\w*$/.exec(x.toString())[1], _ = /^\/.*\/(\w*)$/.exec(x.toString())[1];
...
var k1 = Object.assign({
  ...
  setup(x) {
    ...
    return (c, t) => (openBlock(), createElementBlock("div", D1, [
      createBaseVNode("img", {
        src: unref(n),
...
var k0 = F1(k1, [["__scopeId", "data-v-b52caae3"]]);
var H1 = [
  z0,
  k0
];
...
//# sourceMappingURL=@code-apron_vue-next.js.map

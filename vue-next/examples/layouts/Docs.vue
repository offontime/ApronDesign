  ...
  <div class="docs-layout">
        ...
        <div class="nav-group" v-for="groupItem in NavGroups" :key="groupItem.key">
          ...
          <div class="nav-group-container">
            <div v-for="item in groupItem.children" :key="item.key">
              <!-- 为链接 -->
              <RouterLink v-if="item.href" :to="item.href" style="text-decoration: none;">
                <div :class="['nav-item', item.href === $route.path ? 'nav-item-active' : '']">{{ item.title }}</div>
              </RouterLink>
              <!-- 不为连接 -->
    ...
    <div :class="['content', fullScreen ? 'content-fullscreen' : '']">
      <div class="main-document-container">
        <div style="height: 4000px">正文：{{ $route.path }} |||</div>
      </div>
    </div>
  </div>
</template>
...
const handleFullScreenToggle: Function = function () {
...
const NavGroups: Array<any> = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        href: '/components/circle-button',
        key: 'circlebutton',
        file: 'circlebutton.md',
        title: '圆按钮 CircleButton'
      },
      {
      ...
      {
        href: '/components/input-captcha',
        key: 'inputcaptcha',
        file: 'inputcaptcha.md',
        title: '验证码输入框 InputCaptcha'
      },
      // {
      //   href: '/components/inputtag',
      //   key: 'inputtag',
      //   file: 'inputtag.md',
...
<style src="./styles/Docs.less" lang="less" scoped></style>